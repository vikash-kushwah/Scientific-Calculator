...
class 
   ScientificCalculator  {
	...
	private void initialize() {
		...
		frmScientificCalculator .getContentPane().setBackground(new Color(147,206,201));
		frmScientificCalculator .getContentPane().setFont(new Font("Calibri", Font.PLAIN, 15));
		frmScientificCalculator .getContentPane().setForeground(SystemColor.windowBorder);
		...
		frmScientificCalculator .getContentPane().add(textPanel);
		...
		frmScientificCalculator .getContentPane().add(butttonPanel);
		...
		frmScientificCalculator .setBounds(200, 100, 400, 500);
